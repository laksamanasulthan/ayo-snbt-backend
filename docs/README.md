...
| Doc                                        | What it covers                                                                                                     |
| ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| [GETTING-STARTED.md](./GETTING-STARTED.md) | Setup, **Docker mode (recommended, hot reload)** vs local host mode, known gotchas                                 |
...
| [SCALING.md](./SCALING.md)                 | Complete scaling guide: mental model, 7 levers step-by-step, capacity math, traffic-surge runbook, troubleshooting |
