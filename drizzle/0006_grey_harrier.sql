...
CREATE UNIQUE INDEX "question_tag_uq" ON "question_tags" USING btree ("question_id","tag_id");--> statement-breakpoint
CREATE INDEX "question_tag_tag_idx" ON "question_tags" USING btree ("tag_id");